                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="search-form">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group mt10">
                                <input type="number" class="form-control" name="postal" placeholder="Postal Code" />
                            </div>
                            <div class="col-md-4 form-group mt10">
                            ...
                            <div class="col-md-4 form-group mt10">
                                <input type="number" class="form-control" name="bed" placeholder="Minimum Bedrooms" />
                            </div>
                            <div class="col-md-4 form-group mt10">
                                <input type="number" class="form-control" name="bath" placeholder="Minimum Bathrooms" />
                            </div>

                            <div class="col-md-12 text-center mt10">
                                <div class="row">
                                    <div class="col-md-6 form-group mt10">
                                        <input type="number" class="form-control" name="min" placeholder="Minimum Cost" />
                                    </div>
                                    <div class="col-md-6 form-group mt10">
                                        <input type="number" class="form-control" name="max" placeholder="Maximum Cost" />
                                    </div>
                                </div>
                            </div>
    ...
    <form id="save-search-form">
        ...
        <div class="modal-body">
            <div class="form-group">
                <input class="form-control" name="save_search_name" id="save_search_name" required />
            </div>
        </div>
